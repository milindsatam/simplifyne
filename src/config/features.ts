export const FEATURES = {
  showExpand: true, // Expand CTAs on hero cards + case study cards
  showWorkNav: true, // Work nav item
  showProductsNav: true, // Products nav item
  showBlogNav: true, // Blog nav item
