...
export function Hero() {
  return (
    // Below lg, the header is the floating island (not normal flow), so this
    // top padding is a deliberate clearance calc on the shared tokens:
    // island height plus its offset plus a generous gap. From lg up it
    // reverts to pure breathing room above the real, in-flow header,
    // unchanged from before.
    <section
      data-hero
      className="bg-brand pt-[var(--content-clearance-mobile)] pb-8 sm:pt-[var(--content-clearance-tablet)] lg:pt-[8rem]"
    >
